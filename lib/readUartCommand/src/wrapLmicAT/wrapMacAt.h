...
#define EEPROM_START_ADDR_CH_FREQ       0x08080050
#define EEPROM_START_ADDR_CH_DCYCLE     0x08080054
#define EEPROM_START_ADDR_CH_DRRANGE    0x08080055
#define EEPROM_START_ADDR_CH_STATUS     0x08080056
